/* 
	...
	primverifyslow.cl - Bryan Little 4/2025, montgomery arithmetic by Yves Gallot
	
	compute primorial modulo large prime without product table
...
__kernel __attribute__ ((reqd_work_group_size(256, 1, 1))) void primverifyslow(
