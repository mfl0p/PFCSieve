/*
	...
	primsetup.cl - Bryan Little 4/2025, montgomery arithmetic by Yves Gallot
	
	setup first primorial less than starting range
...
__kernel void primsetup(__global ulong8 * g_prime, __global uint * g_primecount,
		 	__global ulong * g_smallprimeprod, const uint start, const uint end) {
